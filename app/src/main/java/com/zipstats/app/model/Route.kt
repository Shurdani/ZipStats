...
data class Route(
    ...
    val weatherVisibility: Double? = null, // Visibilidad en metros (para detectar niebla/talaia en Barcelona)
    val weatherDewPoint: Double? = null, // Punto de rocío en °C (para detectar condensación - crítico para Barcelona)
    ...
    fun toMap(): Map<String, Any?> = mapOf(
        ...
        "weatherVisibility" to weatherVisibility,
        "weatherDewPoint" to weatherDewPoint,
    ...
    companion object {
        ...
        fun fromMap(id: String, map: Map<String, Any?>): Route {
            ...
            return Route(
                ...
                weatherDewPoint = (map["weatherDewPoint"] as? Number)?.toDouble(),
