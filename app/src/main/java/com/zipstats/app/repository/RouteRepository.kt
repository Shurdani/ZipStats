...
class RouteRepository @Inject constructor(
    ...
    /**
     * Obtiene la siguiente página de rutas del usuario actual sin points
     */
        ...
        return try {
            ...
            val routes = snapshot.documents.mapNotNull { doc ->
                try {
                    ...
                    Log.e(TAG, "Error al parsear ruta de paginación ${doc.id}", e)
                    null
                }
            }
            ...
            Log.e(TAG, "Error al obtener siguiente página de rutas", e)
            Result.failure(e)
        }
    }

    /**
     * Obtiene una ruta completa incluyendo points para el detalle
     */
    suspend fun getRouteWithPoints(routeId: String): Result<Route> {
        return try {
            ...
            Log.e(TAG, "Error al obtener ruta con points", e)
            Result.failure(e)
        }
    }
