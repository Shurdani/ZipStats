...
object CityUtils {
     ...
     * de toda la ruta. Elimina duplicados consecutivos para evitar
     * repeticiones cuando el usuario permanece en la misma ciudad.
     */
    ...
    private fun buildCircularTitle(route: Route, vehicleType: VehicleType?): String {
        ...
        return when {
            ...
            cities.size == 1 ->
                ...
                // Varias ciudades → título genérico con vehículo para no alargar
                "Ruta circular$vehicleSuffix"
        }
    }
